                ...
                <v-layout wrap>
                  ...
                  <v-flex xs12 md6>
                    <v-text-field
                      ...
                      :error="errors.has('businessType')"
                      :error-messages="errors.collect('businessType')"
                      v-validate.disable="'required'"
                      autocomplete="off"
                    ></v-text-field>
                  </v-flex>
                  ...
                  <v-flex xs12 md6>
                    <v-text-field
                      ...
                      :error-messages="errors.collect('streetAddress')"
                      v-validate.disable="'required'"
                      autocomplete="off"
                    ></v-text-field>
                  </v-flex>
                  <v-flex xs12 md6>
                    <v-autocomplete
                      ...
                      :error="errors.has('addressLocality')"
                      :error-messages="errors.collect('addressLocality')"
                      v-validate.disable="'required'"
                      autocomplete="off"
                      class="inputCity"
                    />
                  ...
                  <v-flex xs12 md6>
                    <v-text-field
                      ...
                      :error="errors.has('addressRegion')"
                      :error-messages="errors.collect('addressRegion')"
                      v-validate.disable="'required'"
                      autocomplete="off"
                    ></v-text-field>
                  </v-flex>
                  ...
                  <v-flex xs12 md6>
                    <v-text-field
                      ...
                      :error-messages="errors.collect('contactPhone')"
                      v-validate.disable="'required'"
                      autocomplete="off"
                    ></v-text-field>
                  </v-flex>
