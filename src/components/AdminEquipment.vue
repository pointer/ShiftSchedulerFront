  ...
  <div>
                ...
                <v-layout wrap>
                  ...
                  <v-flex xs12>
                    <v-text-field
                      ...
                      :error="errors.has('equipmentName')"
                      :error-messages="errors.collect('equipmentName')"
                  ...
                  <v-flex xs12>
                    <v-text-field
                      ...
                      "
                      :error="errors.has('equipmentDescription')"
                      :error-messages="errors.collect('equipmentDescription')"
                      v-validate.disable="'required'"
                      autocomplete="off"
                    ></v-text-field>
                  </v-flex>
    ...
    >
      <template v-slot:items="props">
        ...
        <td>{{ props.item.equipmentDescription }}</td>
