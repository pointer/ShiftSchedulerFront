      ...
      <v-toolbar-items>
        ...
        <v-menu v-if="admin" offset-y class="hidden-sm-and-down">
          <template v-slot:activator="{ on }">
            <v-btn icon v-on="on" class="btnAdmin">
...
export default {
  ...
  metaInfo() {
    return {
      ...
      meta: [
        { name: 'msapplication-itemColor', content: '#ffc40d' },
  ...
  computed: {
    ...
    adminItems() {
      return [
        ...
        {
          title: this.$t('adminItems.SITE'),
          link: 'admin-sites',
          icon: 'mdi-garage-alert',
          class: 'btnAdminSite'
        },
        {
          title: this.$t('adminItems.ASSIGNMENTS'),
          link: 'admin-assignments',
          icon: 'mdi-garage-alert',
          class: 'btnAdminAssignments'
        }
      ]
    },
    menuItems() {
