...
export default {
  ...
  computed: {
    roles() {
      return [
        ...
        { name: this.$t('roles.AGENT'), value: 'agent' }
      ]
    },
    allCities() {
  ...
  methods: {
    ...
    //   //   'Object.fromEntries : ',
    //   //   JSON.stringify(
    //   //     Object.fromEntries(this.editItem.avatar.formData.entries())
    //   //   )
    //   // )
    //   // // for (const pair of req.avatar.formData.entries()) {
    //   // //   fileType = pair[1].type
    //   // // }
    //   // const formData = this.editItem.avatar.serializeObject()
    //   // console.log('serializeObject ', formData)
    //   // const image = fs.readFileSync(req.avatar.imageURL)
    ...
    //   // }
    //   // debugger
    //   // if (this.editItem.avatar) {
    //   //   let fileType = ''
    //   //   for (const pair of this.editItem.avatar.formData.entries()) {
    //   //     fileType = pair[1].type
    //   //     this.editItem.avatar = {
    //   //       contentType: fileType,
    //   //       data: new Buffer(this.editItem.avatar.imageURL)
    //   //     }
    //   // this.save()
    //   //   }
    //   // }
